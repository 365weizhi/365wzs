...
class AdminController extends AppController{
	...
	*/
	public function index(){
		...
		$this->set("Category", $this->Content->find("all"));
	...
	*/
	public function category($cid=0){
		if(isset($_POST['data'])){
		    $this->addcat($_POST['data']['cid'], $_POST['data']['category']);
	...
	*/
	function addcat($cid, $name){
		$arr = array();
		$arr['id'] = $cid;
		$arr['name'] = $name;
		if($this->Cat->save($arr))
		    return true;
		else
		    return false;
	}
