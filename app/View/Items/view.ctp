<div class="column-3">
    <div class="column-2 product-author">
        <table>
            <tr>
    ...
    <div class="column-3 product-wrapper">
        <div class="column-3 product">
            <div class="column-2 image">
                ...
                -->
                <?php echo $this->Html->image('static/beauty1.jpg') ?>
            </div>
            <div class="column-1 description">
                <p>丽江地处我国西南边陲，位于云南省西北部地区。居于青藏高原南端、横断山脉向云贵高原北部云岭山脉过渡的衔接地段，兼有两种以上地形特征。境内地形地貌多样，含高原雪山、河谷、深峡、草甸、平坝相结合的地貌特征及自然景观资源，同时气候变化显著。</p>
                <!--
